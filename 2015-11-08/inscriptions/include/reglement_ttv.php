<input id="reglement" name="reglement" type="hidden" value="<?php echo $_SESSION['tarif_ttv'] ?>">
<div align="center">
    <table width="960" align="center"  cellspacing="0"  class="titre4_anthracite" >
  	...
  	<table width="960" border="0" class="titre4_anthracite" >
        <tr align="left">
            <td><span class="Style14"> La participation financi&egrave;re est fix&eacute;e &agrave; <?php echo $_SESSION['tarif_ttv'] ?>&euro; et correspond &agrave; la participation pour les repas </span></td>
        </tr>
    </table>
</div>
