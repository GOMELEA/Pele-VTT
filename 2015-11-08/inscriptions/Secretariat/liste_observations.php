...
<table width="1200" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>
  	<p align="center" class="Style11">Liste des observations trié par de la plus récente à la moins récente: </p>
	<table border="0">
      <tr class="Style20">
        <td width="150">Nom</td>
        <td width="180">Pr&eacute;nom</td>
        <td width="110">Type</td>
        <td width="600">Observation</td>
        </tr>
	<?php  
		   $req_liste= "  SELECT nom_usage, prenom, `index`, `type`, observation FROM fiche WHERE LENGTH(TRIM(observation))>3 ".$_SESSION['and']."  order by `index` DESC; ";
		...
		<td ><?php echo $tabres['observation']; ?></td>
		</tr>
		<?php
		 }
		?>
