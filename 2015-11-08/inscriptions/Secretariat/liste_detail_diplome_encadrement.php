...
<table width="990" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td align="center">
  	<p align="center" class="Style11">Liste des <? if ($type!="") echo $type; else echo 'diplomés';if ($stagiaire==1) echo ' en stage'; ?> avec une équivalence de <?php echo $diplome;  ?>: </p>
	...
	<?php   
		...
		<td><?php if ($tabres['diplome_encadrement_ok']==1) echo "Reçu";else echo "en attente"; ?></td>
		<td><?php if ($tabres['attestation_encadrement_ok']==1) echo "Reçu";elseif ($tabres['attestation_encadrement']==1) echo "en attente"; ?></td>
		</tr>
		<?php
		 }
		?>
