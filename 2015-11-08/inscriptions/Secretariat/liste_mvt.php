...
<table width="990" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>
  	<p align="center" class="Style11">Liste des <?php echo $type; ?> classé par mouvement: </p>
	...
	<?php   $req_liste= "  SELECT * FROM fiche WHERE type= '".$type."'  ".$_SESSION['and']." order by mouvements" ;
		...
		<td><?php echo $tabres['mouvements']; ?></td>
		</tr>
		<?php
		 }
		?>
  ...
  <tr>
    <td>
  	<p align="center" class="Style11">Liste des <?php echo $type; ?> classé par Code Postal et par Paroisse: </p>
	<table width="1200" border="0">
      <tr class="Style3">
        <td>Titre</td>
        <td>Nom</td>
	...
	<?php   $req_liste= "  SELECT * FROM fiche WHERE type= '".$type."'  ".$_SESSION['and']." order by cdpostal, ville,paroisse" ;
		   $res_liste= log_mysql_query($req_liste , $mysql);
		   while ($tabres = mysql_fetch_array ($res_liste))
		  {$tabres=stripslashes_deep($tabres);
		 ?>
		...
		<td><?php echo $tabres['cdpostal']; ?></td>
		<td><?php echo $tabres['ville']; ?></td>
		<td><?php echo $tabres['paroisse']; ?></td>
		</tr>
		<?php
		 }
		?>
