...
<body>
<?php
include('Secretariat/include/base/connexion_serveur.php');
?>
<table width="990" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>
  	<p align="center" class="Style11">Liste des fiches en attente : </p>
	<table width="1200" border="0">
      <tr class="Style20">
        ...
        <td><div align="center">Fiche d'inscription</div></td>
	...
	<?php  
		   $req_liste= "  SELECT * FROM fiche INNER JOIN inscription ON inscription.index_inscription= fiche.fiche_numero_inscription ".
		   				"WHERE documents_signe<> '1' or inscription.regle<>'1' order by date_inscription, fiche_numero_inscription ; ";
		...
		<td align="center"><?php echo $tabres['charte_pelerin']; ?>
		  <div align="center"></div></td>
		<td align="center"><?php echo $tabres['casier']; ?>
		  <div align="center"></div></td>
