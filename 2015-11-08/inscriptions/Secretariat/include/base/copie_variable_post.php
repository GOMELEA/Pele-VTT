...
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx     éléments de la FICHE
include('../include/base/connexion_serveur.php');

$_fiche_numero_inscription=$_POST['index_inscription'];
$_route_index=$_SESSION['index_route'];
$_type=$_POST['type'];
$_titre=$_POST['titre'];
$_code_recherche=$_POST['code_recherche'];
...
//**********************Mise à 0 des jours en dehors du camp et remplissageautomatique pour les collégiens
...
$heure=array(7,9,12,14,19,20,22);
  ...
  for($j=0;$j < 7;$j++) 
  {
	...
	{ 	// ******************************************   Calcul de la date correspondant à la cellule  ***************************
		...
		if ($date<maketime($_SESSION['jour_debut_precamp']) or $date>maketime($_SESSION['jour_fin_postcamp'])) $$variable=0;
	}
  }
...
$_besoin_vtt="0";
$_fiche_liaison=$_POST['fiche_liaison'];
...
$_regime=mysql_real_escape_string($_POST['regime']);
$_charte_pelerin=$_POST['charte_pelerin'];
$_gg=$_POST['gg'];
$_sentinelle=$_POST['sentinelle'];
...
$_manipulation_denrees=$_POST['manipulation_denrees'];
$_documents_signe=$_POST['documents_signe'];
$_inscrit_DDCS=$_POST['inscrit_DDCS'];
$_equipe=$_POST['equipe'];
$_present_au_pele=$_POST['present_au_pele'];
$_casier=$_POST['casier'];
