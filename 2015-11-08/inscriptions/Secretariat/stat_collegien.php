...
<table width="1200" border="0" align="center" bgcolor="#FFFFFF" >
    ...
    <tr>
        <td> <p align="center" class="titre2_marron">Statistiques Collégiens: </p></td>
    </tr>
    <tr>
        <td><p class="titre2_marron">R&eacute;partition des Collégiens : </p></td>
    </tr>
    <tr>
        <td>
            <table border="1" class="titre2_noir">
                <tr>
                    ...
                    <td width="110" colspan="2"><div align="center">6 ème</div></td>
                    <td width="110" colspan="2"><div align="center">5 ème</div></td>
                    <td width="110" colspan="2"><div align="center">4 ème</div></td>
                	...
                	<?php
						...
						$classe = array("CM2","6ème", "5ème", "4ème","3ème","2nd", "1ère");
		  				$sexe = array("H", "F");
						// Boucle sur le sexe
						for($s=0;$s < 2;$s++) 
						{
    ...
    <tr>
        <td><p class="titre2_marron">Suivi des Collégiens : </p></td>
    </tr>
    	<td>
            <table border="1" class="titre2_noir">
                <tr>
                	...
                	<?php
						...
						for($c=0;$c < 7;$c++) 
						{
							$req="select nom_usage, prenom,date_naissance  FROM `fiche` WHERE type = 'collegien' and classe='".$classe[$c]."' " .$_SESSION['and'] ;
							$res = log_mysql_query($req , $mysql);
							while ($tabres=mysql_fetch_array($res))
							{
                ...
                <tr>
                	<?php
						...
						for($c=0;$c < 7;$c++) 
						{
							...
							while ($tabres=mysql_fetch_array($res))
							{
								$req1="select count(*) FROM `fiche` WHERE `type`='staff' and nom_usage='".$tabres['nom_usage']."' and prenom='".$tabres['prenom']."' and date_naissance='".$tabres['date_naissance']."'  " ;
								$res1 = log_mysql_query($req1 , $mysql);
								$resultat=mysql_fetch_array($res1); 
								if ($resultat[0]>0) 
								{
