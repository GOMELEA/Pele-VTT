...
<table width="990" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td align="center">
  	<p align="center" class="Style11">Liste des ttv en poste de <?php echo $poste; ?> : </p>
	...
	<?php   $req_liste= "  SELECT * FROM fiche WHERE type= 'ttv' and ".$poste."=1  ".$_SESSION['and']." order by nom_usage" ;
	...
	<BR><br>
<?php 
$condition ="and type= 'ttv' and ".$poste."=1 ";
