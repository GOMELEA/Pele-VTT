            ...
            <table width="1200" border="0">
                ...
                <tr class="Style25">
                    ...
                    <?php
                        ...
                        if ($tabres[43]=="0000-00-00" and $tabres['demande_attestation']=='1') echo ' de <a href="secretariat_inscription.php?Selection='.$tabres['index_inscription'].'&go=Afficher"> l\'attestation et du reçu,</a>';
                    ?> 
                    </td>
                </tr>
				<?php
